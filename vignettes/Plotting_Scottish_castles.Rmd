...
This package aims at creating a package with data and specific functions to plot castles in Scotland according to whether they have been visited or not by me.
...
```{r open files ,image.width=10, image.height=15,dpi=500}
data(visits)
data(locations)
data(reg)
data(topo_df)
...
ggsave(mappy, file=here ("Figures","Map_of_Scotland_final2.png"),dpi=500,width=10,height=15,units="cm")
